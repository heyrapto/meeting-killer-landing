...
function FAQItem({ faq, isOpen, onToggle }: FAQItemProps) {
  return (
    <div className="border border-[#E2E8F0] rounded-[16px] sm:rounded-[20px] lg:rounded-[24px] overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
      <button
        onClick={onToggle}
        className="w-full px-6 sm:px-8 lg:px-[32px] py-6 sm:py-7 lg:py-[32px] flex items-center justify-between text-left hover:bg-[#F5F7FA] transition-all duration-300"
      >
...
export default function FAQsSection() {
  ...
  return (
    <section
      id="faqs"
      className="py-16 sm:py-20 lg:py-[92px] px-4 sm:px-6 lg:px-[80px] relative w-full max-w-[1440px] mx-auto overflow-hidden bg-[#EFF4FF] rounded-[40px] mb-6"
    >
